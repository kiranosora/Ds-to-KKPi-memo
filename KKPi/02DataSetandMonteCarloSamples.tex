...
We use 3.195 $fb^{-1}$ data set collected at $E_{cm} = 4.178 GeV$ by BES\uppercase\expandafter{\romannumeral3} detector in 2016. Both data sample and Monte Carlo samples are reconstructed under BOSS7.0.3. Totally 35 rounds of generic MC with each round equaling to data size are used for background study. They are avaulable at
