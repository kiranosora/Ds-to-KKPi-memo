...
\par{As MIPWA need more data events, we do not requre $D_{s}^{+}$ and $D_{s}^{-}$ appear in pairs. 
...
\begin{figure*}[h]
 ...
 \caption{Two dimensional plane of ${\Delta{M} \equiv M(D_{s}^{+}\gamma) - M(D_{s}^{+})}$ versus ${M_{rec}}$ from the simulated ${D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+}}$ decyas. The red(green) dashed lines mark the mass window for the $D_{s}^{+}$ Cat. \#0( Cat. \#1) around the $M_{rec}$($\Delta{M}$) peak. }
\label{2DAll}
\end{figure*}
...
\begin{figure*}[h]
 ...
 \mbox{
  %\vskip -1.5cm
  \begin{overpic}[width=0.8\textwidth]{plot/Cat0Variables.png}
  \end{overpic}
 }
...
\begin{figure*}[h]
 ...
 \mbox{
  %\vskip -1.5cm
  \begin{overpic}[width=0.8\textwidth]{plot/Cat1Variables.png}
  \end{overpic}
 }
...
\end{figure*}
    ...
    \begin{figure*}[h]
        ...
        \mbox{
            %\vskip -1.5cm
            \begin{overpic}[width=0.48\textwidth]{plot/MIPWA-sig.png}
            \end{overpic}
        }
        \mbox{
            %\vskip -1.5cm
            \begin{overpic}[width=0.48\textwidth]{plot/MIPWA-bkg.png}
            \end{overpic}
        }
...
\begin{figure*}[h]
 ...
 \caption{The fit to the signal $D_{s}$ invariant mass ($M_{D_{s}^{2}}$) spectrum after BDTG requirement, the area between the pink arrows is the signal area of the sample for MIPWA. }
\label{MIPWA-ST}
\end{figure*}
...
\par{We empirically parameterize the $f_{0}(980)$ with the following function:
    ...
    \begin{figure*}[h]
        ...
        \mbox{
            %\vskip -1.5cm
            \begin{overpic}[width=0.8\textwidth]{plot/Fit-SWave.png}
            \end{overpic}
        }
