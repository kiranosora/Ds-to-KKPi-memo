...
With the updated MC sample(DIY MC) based on the amplitude analysis results obtained from the fit to data, the double efficiencies without any kinematic fit requirement applied are determined and listed in Table\ref{DT-eff}.
