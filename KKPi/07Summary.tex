...
\par{
    ...
    \begin{table}[htbp]
        ...
        \begin{center}
            \begin{tabular}{cc}
                ...
                $5.47\pm0.07_{stat.}\pm0.13_{sys.}$                     &  BESIII(this analysis)    \\
    ...
    \begin{table}[htbp]
        ...
        \begin{center}
            \begin{tabular}{cc}
                ...
                \hline
                $D_{s}^{+} \rightarrow \bar{K}^{*}(892)^{0}K^{+}$, $\bar{K}^{*}(892)^{0} \rightarrow K^{-}\pi^{+}$              & $2.62\ \pm\ 0.04_{stat.}\ \pm\ 0.07_{sys.}$  \\
                $D_{s}^{+} \rightarrow \phi(1020)\pi^{+}$, $\phi(1020) \rightarrow K^{+}K^{-}$                                  & $2.26\ \pm\ 0.05_{stat.}\ \pm\ 0.06_{sys.}$  \\
                $D_{s}^{+} \rightarrow S(980)\pi^{+}$, $S(980) \rightarrow K^{+}K^{-}$                                          & $0.90\ \pm\ 0.04_{stat.}\ \pm\ 0.11_{sys.}$  \\
                ...
                $D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+}$ total branching fraction                                              & $5.47\ \pm\ 0.07_{stat.}\ \pm\ 0.13_{sys.}$ \\
                \bottomrule\bottomrule
            \end{tabular}
        \end{center}
    \end{table}
    According to the Eq.~\ref{bf-a0} in Sec.~\ref{f0-a0-discussion}, we can obtain $\mathcal{B}(D_{s}^{+} \rightarrow a_{0}(980)\pi^{+}, a_{0}(980) \rightarrow K^{+}K^{-})$ is about 0.14\%, which is much less than $\mathcal{B}(D_{s}^{+} \rightarrow S(980)\pi^{+})$ listed in Table~\ref{total-BF}. 
    ...
    Our results are consistent with theory predictions based on solutions (A1) and (S4) listed in Table~\ref{theory-prediction}.
    \begin{table}[htbp]
