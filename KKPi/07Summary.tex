...
\par{
    ...
    \begin{table}
        ...
        \end{center}
    \end{table}
    In this analysis, as $a_{0}(980)$ and ${f_{0}(980)$ are close to each other and parameters of $f_{0}(980)$ is not well measured, 
        ...
        We also measured the branching farction and the value is $\mathcal{B}(D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+})=(5.38\pm0.07_{stat.}\pm0.11_{sys.})\%$ and the precision is the best at present.
