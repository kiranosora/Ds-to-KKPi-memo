...
\abstracttext{
  ...
  The amplitude analysis results provide an accurate detection efficiency and allow measuement of the branching fraction of $D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+}$ to be $\mathcal{B}(D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+})=(5.47\pm0.08_{stat.}\pm0.13_{sys.})\%$.
