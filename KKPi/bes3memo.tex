...
\abstracttext{
  ...
  And we also measured the branching fraction of   $D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+}$ and the result is $\mathcal{B}(D_{s}^{+} \rightarrow K^{+}K^{-}\pi^{+})=(5.47\pm0.07_{stat.}\pm0.11_{sys.})\%$.
