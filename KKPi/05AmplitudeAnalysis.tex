...
With the requiring the statistical significance larger than 5 standard deviations, there are 6 intermediate processes, 
...
\par{
    ...
    \begin{table*}[tp]  
        ...
        Here \uppercase\expandafter{\romannumeral1},  \uppercase\expandafter{\romannumeral2}, \uppercase\expandafter{\romannumeral3}, \uppercase\expandafter{\romannumeral4} and \uppercase\expandafter{\romannumeral5} 
        ...
        \begin{tabular}{l|ccccccc} 
            ...
            \hline                                                                                                                                          
            \multirow{3}{*}{$D_{s}^{+} \rightarrow \phi(1020)\pi^{+}$}                  & $\phi$        &0.49      &0.10       &0.06   &0.07  &0.08  &0.51 \\
                                                                                        & $\rho$        &0.49      &0.14       &0.08   &0.41  &0.19  &0.69 \\
                                                                                        & FF            &0.44      &1.13       &0.04   &0.40  &0.08  &1.28 \\
            \hline                                                                                                                                         
            \multirow{3}{*}{$D_{s}^{+} \rightarrow S(980)\pi^{+}$}                      & $\phi$        &0.98      &0.25       &0.04   &0.11  &0.06  &1.02    \\
